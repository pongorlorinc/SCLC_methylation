...
bwfile = c("../data/SCLC_NAPY_ChIP/NA_chip/bigwigs/GSM1700639_H889_ASCL1.scaled.bw",
           "../data/SCLC_NAPY_ChIP/NA_chip/bigwigs/GSM1700641_H82_NEUROD1.scaled.bw",
           "../data/NCI-H1048_POU2F3_rep1.hg19_clean.bam.scaled.bw",
           "../data/NCI-H889_H3K27ac_rep1.hg19_clean.bam.scaled.bw",
           "../data/NCI-H82_H3K27ac_rep1.hg19_clean.bam.scaled.bw",
           "../data/NCI-H1048_H3K27ac_rep1.hg19_clean.bam.scaled.bw",
           "../data/DMS114_H3K27ac_rep1.hg19_clean.bam.scaled.bw")
